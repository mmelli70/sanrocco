...
- [ ] T009-01 Add `CONTENT.sections.gelaterie` array (4 entries) to `index.html`:
  ```js
  ...
  ```
- [ ] T009-02 Add string keys to `CONTENT.strings.en`: `gelaterie_title`, `gelaterie_openMaps`, `gelaterie_favourite`
...
- [ ] T009-03 Add `<div class="screen" id="gelaterie" hidden>` to `index.html`; prepend `createSectionHeader('gelaterie_title')`
- [ ] T009-04 Write `renderGelaterie()`: same pattern as `renderRestaurants()` from spec 004 — reuse `renderFavouriteBadge()`. Call on `DOMContentLoaded`.
...
- [ ] T009-05 All 4 cards render at 360 dp ✅
- [ ] T009-06 Gelateria Aurora shows ★ favourite badge ✅
- [ ] T009-08 Maps links open on device ✅
- [ ] T009-09 Back button returns to home ✅
